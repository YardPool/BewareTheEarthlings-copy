...
public:
	...
	virtual TSharedRef<class IDialogueEditor> CreateDialogueEditor(const EToolkitMode::Type Mode, const TSharedPtr< class IToolkitHost >& InitToolkitHost, class UObject* Object);

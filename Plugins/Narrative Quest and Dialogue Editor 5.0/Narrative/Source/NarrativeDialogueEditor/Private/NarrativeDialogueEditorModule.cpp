...
void FNarrativeDialogueEditorModule::StartupModule()
{
	...
	TSharedPtr<FAssetTypeActions_DialogueAsset> DialogueAssetTypeAction = MakeShareable(new FAssetTypeActions_DialogueAsset(GameAssetCategory));
...
TSharedRef<IDialogueEditor> FNarrativeDialogueEditorModule::CreateDialogueEditor(const EToolkitMode::Type Mode, const TSharedPtr< class IToolkitHost >& InitToolkitHost, class UObject* Object)
{
	TSharedRef< FDialogueGraphEditor > NewDialogueEditor(new FDialogueGraphEditor());
	NewDialogueEditor->InitDialogueEditor(Mode, InitToolkitHost, Object);

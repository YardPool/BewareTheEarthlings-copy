...
void FDialogueEditorStyle::Initialize()
{
	...
	StyleSet->Set(FName(TEXT("ClassThumbnail.DialogueAsset")), new IMAGE_BRUSH("DialogueIcon64x64", FVector2D(64, 64)));
	StyleSet->Set(FName(TEXT("ClassIcon.DialogueAsset")), new IMAGE_BRUSH("DialogueIcon16x16", FVector2D(16, 16)));

...
enum class EStateMachineCompletionType : uint8
{
	...
	Rejected,
	// We ran out of more steps whilst machine was still running
...
struct NARRATIVE_API FStateMachineResult
{
	...
	FStateMachineResult(EStateMachineCompletionType NewCompletionType, class UQuestBranch* NewBranch, class UQuestState* NewFinalState)
	{
	...
	UPROPERTY()
	EStateMachineCompletionType CompletionType = EStateMachineCompletionType::NotAccepted;
...
public:
	...
	* Begins reading input at DataIndex. Will decrement RemainingSteps and automatically fail after it hits 0. */
	virtual FStateMachineResult RunState(bool& bOutMadeProgress, const FString& InputString = "");
...
public:
	...
	*/
	virtual UQuestState* TryBranch(const FString& Input, bool& bOutMadeProgress);

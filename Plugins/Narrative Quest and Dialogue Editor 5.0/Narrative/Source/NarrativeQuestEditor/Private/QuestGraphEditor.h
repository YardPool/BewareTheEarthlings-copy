...
protected:
	...
	// CURRENTLY NOT USED: quest graph version of selecting nodes, BP graph already has all these defined 
...
public:
	...
	*/
	...
	/** Spawn quest editor tab */
	//TSharedRef<SWidget> SpawnQuestEditor();
